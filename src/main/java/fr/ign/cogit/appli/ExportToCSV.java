...
public class ExportToCSV {
	 ...
	 */
	public static void exportAppariement (List<Critere> listCritere, double seuilIndecision, 
			List<LigneResultat> listeResultat, String pathToExportTo) {
		...
		try {
			...
			if (listeResultat.get(1).getGeomRef() instanceof Point) {
				typeGeometrie = "POINT";
