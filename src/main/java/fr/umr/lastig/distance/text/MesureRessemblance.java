...
import fr.umr.lastig.util.text.ApproximateMatcher;
import fr.umr.lastig.util.text.MatriceConfiance;
import fr.umr.lastig.util.text.TraitementChainesDeCaracteres;
