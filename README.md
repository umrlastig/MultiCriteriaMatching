...
# Use Cases
- Olteanu Raimond, AM., Mustière, S. (2008). [Data Matching – a Matter of Belief](https://doi.org/10.1007/978-3-540-68566-1_29). In: Ruas, A., Gold, C. (eds) Headway in Spatial Data Handling. Lecture Notes in Geoinformation and Cartography. Springer, Berlin, Heidelberg. 
- Olteanu Raimond, Ana-Maria & Mustiere, Sebastien & Ruas, Anne. (2015). [Knowledge formalization for vector data matching using Belief Theory](http://dx.doi.org/10.5311/JOSIS.2015.10.194). JOURNAL OF SPATIAL INFORMATION SCIENCE. in press. 
- G. Touya, V. Antoniou, A.-M. Olteanu-Raimond, M.-D. Van Damme, [Assessing Crowdsourced POI Quality: Combining Methods Based on Reference Data, History, and Spatial Relations](https://doi.org/10.3390/ijgi6030080). ISPRS Int. J. Geo-Inf. 2017, 6, 80.  
